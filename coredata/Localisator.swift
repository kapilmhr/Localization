...
func getLanguage()-> String {
    return Localisator.sharedInstance.getLanguage()
}
...
class Localisator {
    ...
    private var availableLanguagesArray         = ["DeviceLanguage", "English_en", "Nepali_ne"]
    ...
    var currentLanguage                         = "English_en"
